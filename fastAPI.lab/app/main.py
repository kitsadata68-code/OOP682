...
app = FastAPI() # <--- นี่คือตัวแปร app ที่ Uvicorn มองหา
...
def get_task_service(db: Session = Depends(get_db)):
    # ใช้ SqlTaskRepository ที่เชื่อม DB จริง
...
def mark_task_as_complete(task_id: int, service: TaskService = Depends(get_task_service)):
